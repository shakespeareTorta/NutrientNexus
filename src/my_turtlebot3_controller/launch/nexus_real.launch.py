...
def generate_launch_description():
    ...
    # A twist_stamper converts it to TwistStamped on /cmd_vel for the
    ...
    # Convert Twist → TwistStamped for the physical TurtleBot3 (Jazzy).
    # Install via: sudo apt install ros-jazzy-twist-stamper
    twist_stamper = Node(
